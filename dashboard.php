...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/fpwdmodal.css">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title">Members Statistics</h4>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card ">
                            <div class="header">
                                <h4 class="title">2019 Payments</h4>
                            ...
                            <div class="content">
                                ...
                                <div class="footer">
                                    <div class="legend">
                                        <i class="fa fa-circle text-info"></i> collected
