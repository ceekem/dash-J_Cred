                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="image form-group">
                                ...
                                <label for="cover">
                                  <?php if($row1['cover'] == ''){ ?>
                                  <img class="cover" style="cursor:default;" src="https://ununsplash.imgix.net/photo-1431578500526-4d9613015464?fit=crop&fm=jpg&h=300&q=75&w=400" alt="..."/>
                                  
                                  <?php }
                                        else {
                                  ?>
                                         <img class="cover" style="cursor:default;" src="<?php echo $row1['cover']?>" alt="..."/>
